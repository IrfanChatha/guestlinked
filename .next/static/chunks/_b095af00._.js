...
function Dashboard() {
    ...
    const [websitesCount, setWebsitesCount] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Dashboard.useEffect": ()=>{
            const checkUserAndFetchData = {
                "Dashboard.useEffect.checkUserAndFetchData": async ()=>{
            ...
            }["Dashboard.useEffect.checkUserAndFetchData"];
            checkUserAndFetchData();
            // Listen for auth changes
            const { data: authListener } = supabase.auth.onAuthStateChange({
                "Dashboard.useEffect": (event, session)=>{
                    if (event === 'SIGNED_OUT') {
                        router.push('/');
                    }
                }
...
_s(Dashboard, "7z7cs9tRnq1y3+16XYM3+0hz7b4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=_b095af00._.js.map