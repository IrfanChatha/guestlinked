        ...
        "LoginPage.useEffect": ()=>{
            const checkAuth = {
                "LoginPage.useEffect.checkAuth": async ()=>{
                    const { data: { session } } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                    if (session) {
...
//# sourceMappingURL=_90a6c2fe._.js.map