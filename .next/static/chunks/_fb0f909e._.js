...
"[project]/app/buyer/buyer-dashboard/page.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BuyerDashboard.useEffect": ()=>{
            const checkUserAndFetchData = {
                "BuyerDashboard.useEffect.checkUserAndFetchData": async ()=>{
                    const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSupabase"])();
                    try {
            ...
            }["BuyerDashboard.useEffect.checkUserAndFetchData"];
            // Separate function to load stats without blocking initial render
            const loadStatsInBackground = {
                "BuyerDashboard.useEffect.loadStatsInBackground": async (userId)=>{
                    try {
                        const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSupabase"])();
        ...
        */ // Placeholder stats for now
            ...
            }["BuyerDashboard.useEffect.loadStatsInBackground"];
            checkUserAndFetchData();
            // Simplified auth listener
            const supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSupabase"])();
            const { data: authListener } = supabase.auth.onAuthStateChange({
                "BuyerDashboard.useEffect": (event, session)=>{
                    if (event === 'SIGNED_OUT') {
                        router.push('/');
                    }
                }
...
_s(BuyerDashboard, "k0WZ5RL8DURlE0iqaK9gPenm5Vs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=_fb0f909e._.js.map