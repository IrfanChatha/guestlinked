...
function AddWebsite() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabaseClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('web_sites').insert([
            formData
        ]);
...
//# sourceMappingURL=_17a3d653._.js.map