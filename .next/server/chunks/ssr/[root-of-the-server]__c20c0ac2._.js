...
"[project]/utils/supabase.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/utils/supabase.js [app-ssr] (ecmascript)");
'use client';
;
;
;
...
function HomePage() {
    ...
    const handleGoogleSignIn = async ()=>{
        try {
            ...
            const { data: authData, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithOAuth({
                provider: 'google',
                options: {
            ...
            if (error) {
                ...
                const { data: { user }, error: userError } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.getUser();
                ...
                if (user) {
                    ...
                    const { data: insertData, error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users_settings_tb').upsert({
                        id: authData.user.id,
    ...
    const handleSignUp = async (e)=>{
        ...
        try {
            ...
            const { data: authData, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
                email: signUpData.email,
            ...
            if (authError) {
                ...
                const { data: insertData, error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users_settings_tb').insert([
                    {
                        id: authData.user.id,
    ...
    const handleLogin = async (e)=>{
        ...
        setMessage('');
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
            ...
            if (error) {
                ...
                const { error: updateError } = await __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users_settings_tb').update({
                    last_login: new Date().toISOString()
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c20c0ac2._.js.map